...
# co-ordinates for either the upper left or lower right of a rectangular box
#---------------------------------------------------------------
...
frameSetXY      = Frame(root, borderwidth=3, relief=FLAT, padx = 5, pady = 5)
buttonSetXY     = Button (frameSetXY, width = 10, text = "Set All",  command = lambda: set_all_xy(), state=DISABLED)
buttonSetXY.pack(side=LEFT,  padx = 5, pady = 5)
frameSetXY.pack(side=TOP, padx = 5, pady = 5)
...
Label (frameParamHeader, text = 'Point         X               Y     ').pack(side = LEFT, padx = 5, pady = 2)
